...
case $HARDENING_FLAG in
  ...
  stig)
    enable_fips
    oscap_generate_fix "/usr/share/xml/scap/ssg/content/ssg-rhel7-ds.xml" "xccdf_org.ssgproject.content_profile_stig_aws" "/etc/packer/files/ssg-rhel7-ds-tailoring.xml"
    ;;
