...
data "amazon-ami" "autogenerated_1" {
  filters = {
    ...
    name                = "Windows_Server-2019-English-Full-EKS_Optimized-${var.eks_version}-*"
...
locals {
  ami_description = "EKS Kubernetes Worker AMI on Windows 2019 Full image (k8s: ${var.eks_version})"
  target_ami_name = "amazon-eks-node-${var.eks_version}-windows1809full-${local.timestamp}"
}
